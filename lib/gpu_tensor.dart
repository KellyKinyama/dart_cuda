...
typedef _C_create = ffi.Pointer<ffi.Void> Function(ffi.Int32, ffi.Int32, ffi.Pointer<ffi.Float>);
typedef _D_create = ffi.Pointer<ffi.Void> Function(int, int, ffi.Pointer<ffi.Float>);
typedef _C_destroy = ffi.Void Function(ffi.Pointer<ffi.Void>);
typedef _D_destroy = void Function(ffi.Pointer<ffi.Void>);
typedef _C_copy = ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Float>);
...
typedef _C_op2 = ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>);
typedef _D_op2 = ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>);
typedef _C_pow = ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>, ffi.Float);
...
class CudaEngine {
  ...
  late _D_create createTensor; late _D_destroy destroyTensor;
  late _D_copy getTensorData; late _D_copy getTensorGrad;
  late _D_destroy backward; late _D_destroy zeroGrad; late _D_step tensorStep;
  late _D_op2 addTensors; late _D_op2 subTensors; late _D_op2 mulTensors; 
  late _D_op2 divTensors; late _D_op2 matmulTensors; late _D_pow powTensor;
  late _D_op1 reluTensor; late _D_op1 tanhTensor; late _D_op1 sigmoidTensor;
  ...
  CudaEngine() {
    ...
    destroyTensor = _lib.lookupFunction<_C_destroy, _D_destroy>('destroy_tensor');
...
class Tensor {
  ...
  Tensor._raw(this._handle, this.shape) : length = shape.reduce((a, b) => a * b);
  ...
  factory Tensor.fill(List<int> shape, double val) {
    ...
    final h = engine.createTensor(shape[0], shape.length > 1 ? shape[1] : 1, ptr);
    calloc.free(ptr);
  ...
  Tensor operator +(Tensor o) => Tensor._raw(engine.addTensors(_handle, o._handle), shape);
  Tensor operator -(Tensor o) => Tensor._raw(engine.subTensors(_handle, o._handle), shape);
  Tensor operator *(Tensor o) => Tensor._raw(engine.mulTensors(_handle, o._handle), shape);
  Tensor matmul(Tensor o) => Tensor._raw(engine.matmulTensors(_handle, o._handle), [shape[0], o.shape[1]]);
