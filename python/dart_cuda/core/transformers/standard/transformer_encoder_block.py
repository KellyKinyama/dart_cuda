"""Encoder transformer block — port of
`lib/transformer/transformer_encoder_block.dart` (dart-torch).

Identical structure to TransformerBlock but with `masked=False` enforced
(pure encoder, bi-directional self-attention).
"""
...
class TransformerEncoderBlock(Module):
    def __init__(self, embed_size: int, num_heads: int):
        ...
        self.attention = MultiHeadAttention(num_heads, embed_size, masked=False)
