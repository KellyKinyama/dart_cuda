"""Transformer decoder — port of
`lib/transformer/transformer_decoder.dart` (dart-torch).
...
class TransformerDecoder(Module):
    def __init__(
        ...
        *,
        ...
        self.blocks = [
            TransformerDecoderBlock(embed_size, num_heads, encoder_embed_size)
    ...
    @property
    def encoderEmbedSize(self) -> int: return self.encoder_embed_size
    @property
    ...
    def forward(
        ...
        for b in self.blocks:
            x = b.forward(x, encoder_output, tracker)
